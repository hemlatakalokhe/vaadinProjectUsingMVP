...
- styleapplication-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- styleapplication-ui: main application module, development time
- styleapplication-production: module that produces a production mode WAR for deployment
