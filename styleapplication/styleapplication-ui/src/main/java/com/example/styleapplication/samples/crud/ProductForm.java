package com.example.styleapplication.samples.crud;

import java.util.Collection;

import com.example.styleapplication.samples.backend.DataService;
import com.example.styleapplication.samples.backend.data.Availability;
import com.example.styleapplication.samples.backend.data.Category;
import com.example.styleapplication.samples.backend.data.Product;
